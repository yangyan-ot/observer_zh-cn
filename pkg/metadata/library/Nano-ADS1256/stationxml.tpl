  ...
  <Network code="{{.NetworkCode}}" startDate="1970-01-01T00:00:00.000000Z" restrictedStatus="open">
    ...
    <Station code="{{.StationCode}}" startDate="1970-01-01T00:00:00.000000Z" restrictedStatus="open">
      ...
      <Channel code="{{.ChannelCode1}}" startDate="1970-01-01T00:00:00.000000Z" restrictedStatus="open" locationCode="{{.LocationCode}}">
        ...
        <Sensor resourceId="Sensor-Nano-ADS1256-VEL">
          <Model>{{.VelocitySensorModel}}</Model>
        </Sensor>
        <DataLogger resourceId="Datalogger-Nano-ADS1256-VEL"/>
        <Response>
          ...
          <Stage number="1">
            <PolesZeros name="AS-Nano-ADS1256-VEL" resourceId="ResponsePAZ-Nano-ADS1256-VEL">
              <InputUnits>
                <Name>m/s</Name>
              </InputUnits>
              <OutputUnits>
          ...
          <Stage number="2">
            <Coefficients name="DL-Nano-ADS1256-VEL" resourceId="Datalogger-Nano-ADS1256-VEL">
              <InputUnits>
                <Name>V</Name>
              </InputUnits>
              <OutputUnits>
